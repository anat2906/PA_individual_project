...
})(["font-family:\"Roboto\";font-size:15px;font-weight:600;text-transform:uppercase;color:", ";padding:0.1em 0.8em;background:white;border:none;border:3px solid ", ";border-radius:3px;position:relative;box-shadow:3px 3px 0px ", ";&::after{display:none;content:\" \";z-index:-1;position:absolute;width:100%;height:100%;border-radius:3px;background:repeating-linear-gradient( 45deg,", ",", " 4px,white 4px,white 8px );background-size:500%;bottom:-7px;right:-7px;animation:shadow linear 25s;animation-iteration-count:infinite;}&:focus{outline:none;}&:hover{box-shadow:none;::after{display:block;}}"], _config_var__WEBPACK_IMPORTED_MODULE_2__["colors"].dark_1, _config_var__WEBPACK_IMPORTED_MODULE_2__["colors"].dark_1, _config_var__WEBPACK_IMPORTED_MODULE_2__["colors"].dark_1, _config_var__WEBPACK_IMPORTED_MODULE_2__["colors"].dark_1, _config_var__WEBPACK_IMPORTED_MODULE_2__["colors"].dark_1);
/* harmony default export */ __webpack_exports__["default"] = (Button);

/***/ })

})
//# sourceMappingURL=index.js.bae33d45b973ec12d5e5.hot-update.js.map