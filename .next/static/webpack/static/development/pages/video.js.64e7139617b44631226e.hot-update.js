...
})(["font-family:\"PT Mono\";font-size:13px;border:1px solid ", ";border-radius:3px;padding:0.3em;width:100%;color:", ";display:block;margin-bottom:0.5em;&:focus{outline:none !important;}"], _config_var__WEBPACK_IMPORTED_MODULE_2__["colors"].dark_2, _config_var__WEBPACK_IMPORTED_MODULE_2__["colors"].dark_3);
var Wrapper = styled_components__WEBPACK_IMPORTED_MODULE_1__["default"].div.withConfig({
  displayName: "CommentInput__Wrapper",
  componentId: "sc-6nwsek-1"
})(["background:", ";padding:1em;margin-top:1em;border-radius:3px;a{font-family:\"Roboto\",sans-serif;font-size:16px;font-weight:700;&:hover{text-decoration:underline !important;}}"], _config_var__WEBPACK_IMPORTED_MODULE_2__["colors"].light_1);

function CommentInput(props) {
  return react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(styled_bootstrap_grid__WEBPACK_IMPORTED_MODULE_3__["Col"], {
    xs: 8,
    sm: 8,
    md: 8,
    lg: 8,
...
//# sourceMappingURL=video.js.64e7139617b44631226e.hot-update.js.map